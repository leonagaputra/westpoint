    ...
    <body id="page-top" class="index">
        ...
        <header>        
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <img class="img-responsive" width="256px" height="256px" src="<?php echo $base_url ?>img/error.png" alt="">
                        <div class="intro-text">
                            <!--<span class="name">Belajar Ujian</span>-->
                            <hr class="star-light">
                            <span class="skills">Pendaftaran Gagal. <?php echo $error_msg; ?></span>
                            <div><a href="<?php echo $base_url; ?>index.php/main/signup" class="btn btn-primary btn-lg">Daftar Ulang</a></div>
                        </div>
                    </div>
                </div>
            </div>
