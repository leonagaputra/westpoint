                        ...
                        <form class="form-horizontal" >
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" placeholder="Nama" id="inputEmail" class="form-control" required data-validation-required-message="Masukkan Nama Anda">                                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label" for="inputEmail">Email</label>
                                    <div class="col-lg-10">
                                        <input type="email" placeholder="Email" id="inputEmail" class="form-control" required data-validation-required-message="Masukkan Email Anda">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="password" placeholder="Password" id="inputPassword" class="form-control" required>                                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label" for="inputPerusahaan">Perusahaan</label>
                                    <div class="col-lg-10">
                                        <input type="text" placeholder="Perusahaan" id="inputEmail" class="form-control" >                                        
                                    </div>
                                </div>
